...
Air reaching this region has already lost most of its moisture in the surrounding storm crown.  
As a result, the Corerise tends to be comparatively dry.
...
- harsh wind exposure
- limited settlement
- high visibility skies

This region marks the geographic center of the global wind system.
...
A circular belt surrounding the Corerise.

## Wind Behavior

Violent rising convection and rotating storm systems.
...
- extremely dangerous navigation
- major atmospheric turbulence
...
Strong, steady winds moving in a consistent direction around the pole.
...
Airflow slows and begins rising vertically in this region, reducing horizontal wind strength.
...
Between the Leftwind Calm Belt and the Storm Frontier.

## Wind Direction

Strong steady winds rotating opposite the Inner Wind Belt.
...
- major exploration and travel routes
...
The turbulent boundary between the Outer Wind Belt and the Outer Drift.
...
- chaotic wind shifts
- heavy turbulence
- large updraft columns

## Climate

Storm systems intensify where opposing circulation systems collide and where convection from the cloud sea strengthens.

## Consequences

- extremely hazardous navigation
- frequent lightning storms
- unpredictable island drift
- seasonal energy harvesting

The Storm Frontier forms the outer storm boundary of the habitable sky.
...
Outer atmospheric regions far from the central circulation zones.

## Wind Behavior

Cold steady outward airflow.
...
- isolated drifting islands
- sparse ecosystems
- difficult long-distance travel
- frontier exploration zones

Few large civilizations exist in this region due to the distance from stable trade routes.
